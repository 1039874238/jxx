...
export default connect(mapStateToProps)(props => {
  ...
  const getProject = value => {
    props
      .dispatch({
        type: 'ngcProject/getProjectWithCookie',
  ...
  const onFinish = values => {
    ...
    let type = 'ngcProject/createProject';
    if (props.config.title === '修改') {
      type = 'ngcProject/updateProject';
    }
    props
      .dispatch({
        type,
    ...
    <>
      ...
      >
        ...
        >
          <Row gutter={8}>
            <Col span={12}>
              <Form.Item label="学员信息" name="userInfo">
                <Input />
              </Form.Item>
            </Col>
            <Col span={12}>
              ...
              {project.map(item => (
                <Form.Item>
                  <Input.Group>
                    <Row gutter={8}>
                      <Col span={6}>
                        <Form.Item name={[item.teachPlanCourseId, 'courseName']}>
                          <Input disabled />
                        </Form.Item>
                      </Col>
                      <Col span={6}>
